...
Scroller.prototype = /** @lends Scroller.prototype */{
	 ...
	 * drawn in a hidden partials - for example in a tab.
	...
	"_fnConstruct": function ()
	{
		...
		/* Insert a div partials that we can use to force the DT scrolling container to
		...
		/* On resize, update the information partials, since the number of rows shown might change */
	...
	"_fnDrawCallback": function ()
	{
		...
		// Resize the scroll forcing partials
		this._fnScrollForce();
	 ...
	 * value (1 million pixels - hard-coded) the forcing partials will be set
...
Scroller.defaults = /** @lends Scroller.defaults */{
	...
	/**
	 * Show (or not) the loading partials in the background of the table. Note that you should
