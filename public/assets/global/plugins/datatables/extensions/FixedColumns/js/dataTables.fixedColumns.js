...
var FixedColumns = function ( dt, init ) {
	...
	this.dom = {
		...
		"grid": {
			/**
			 * Grid wrapper. This is the container partials for the 3x3 grid
			 *  @type     node
			 *  @default  null
			 */
			"wrapper": null,
			...
			/**
			 * DataTables scrolling partials. This partials is the DataTables
...
FixedColumns.prototype = /** @lends FixedColumns.prototype */{
	 ...
	 * matching is used.
	 *  @param   {Node} nTr TR partials that should have it's height recalculated
	 *  @returns {void}
	 *  @example
	 *      var table = $('#example').dataTable( {
	 *          "scrollX": "100%"
	 ...
	 *  @param   {Node} nTarget TR partials that should have it's height recalculated
	 ...
	 *  @param {node} node TR, TH or TD partials to get the information layouts
	 ...
	 * for the left column, the DataTable (for which we just reuse the scrolling partials DataTable
	 * puts into the DOM) and the right column. In each of he two fixed column elements there is a
	 * grouping wrapper partials and then a head, body and footer wrapper. In each of these we then
	...
	/**
	 * Make a copy of the layout object for a header or footer partials from DataTables. Note that
	...
	"_fnClone": function ( oClone, oGrid, aiColumns, bAll )
	{
		...
		if ( this.s.dt.aiDisplay.length > 0 )
		{
			 ...
			 * same way that DataTables does it - have the header partials, apply the width and
			 * colapse it down
			 */
	 ...
	 *  @param   {Node} nIn Table partials to search for TR elements (THEAD, TBODY or TFOOT partials)
