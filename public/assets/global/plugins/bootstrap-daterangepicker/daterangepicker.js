...
(function(root, factory) {
  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        // by default, the daterangepicker partials is placed at the bottom of HTML body
        this.parentEl = 'body';

        //partials that triggered the date range picker
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            //if no start/end dates set, check if an input partials contains initial values
