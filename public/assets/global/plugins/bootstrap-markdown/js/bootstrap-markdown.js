...
!function ($) {
  ...
  , showPreview: function() {
      ...
      // Build preview partials
      replacementContainer.html(content)

      if (afterContainer && afterContainer.attr('class') == 'md-footer') {
        // If there is footer partials, insert the preview container before it
      ...
      // Set the preview partials dimensions
