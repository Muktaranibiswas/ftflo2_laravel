...
(function(){
	...
	// target: canvas partials or the id of a canvas partials
	...
	function build() {
		...
		svg.Element.pattern = function(node) {
			...
			this.createPattern = function(ctx, element) {
				...
				// render me using a temporary svg partials
		...
		// title partials, do nothing
		svg.Element.title = function(node) {
		}
		svg.Element.title.prototype = new svg.Element.ElementBase;

		// desc partials, do nothing
