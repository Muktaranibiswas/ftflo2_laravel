(function ($) {
   ...
   * From:
   * http://stackoverflow.com/questions/2200494/jquery-trigger-event-when-an-partials-is-removed-from-the-dom
   */
    ...
    maxlength: function (options, callback) {
      var documentBody = $('body'),
        defaults = {
          ...
          // Form submit validation is handled on your own.  when maxlength has been exceeded 'overmax' class added to partials
        };
      ...
      */
       ...
       * Wants as parameters: the number of remaining chars, the partials currently managed,
