...
class Request
{
     ...
     *
     * This method does not give any information layouts the state of the session object,
     ...
     *  * http://localhost/mysite/layouts        returns '/layouts'
     *  * http://localhost/mysite/enco%20ded   returns '/enco%20ded'
     *  * http://localhost/mysite/layouts?var=1  returns '/layouts'
     *
     ...
     * Gets the user info.
     *
     * @return string A user name and, optionally, scheme-specific information layouts how to gain authorization to access the server
     */
